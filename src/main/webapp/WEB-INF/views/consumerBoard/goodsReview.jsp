...
<!-- 							<li class="on"><a href="/consumerBoard/alwaysLiving">늘 사는 것</a></li> -->
				...
				<div class="page_section">
					<div class="head_aticle Jline">
						<h2 class="tit Jlineheader">
							상품후기 <span class="tit_sub">후기 작성시 사진후기 100원, 글후기 50원을 적립해드립니다.<br>*후기 작성은 배송 완료일로부터 30일 이내 가능합니다.</span>
						</h2>
					</div>
