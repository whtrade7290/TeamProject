                                       ...
                                       <table class="boardView" width="100%" id="jnotice">
                                          <tbody>
                                             <tr>
                                                ...
                                                <td>${ oneNoticeVo.title }</td>
                                             </tr>
                                             <tr>
                                                <th scope="row">작성자</th>
                                                <td>${ oneNoticeVo.id }</td>
                                             </tr>
                                             <tr class="etcArea">
                                                <td colspan="2">
                                                   <ul>
                                                      <li class="date "><strong class="th">작성일</strong>
                                                         <span class="td"><fmt:formatDate
                                                               value="${ oneNoticeVo.regDate }" pattern="yyyy.MM.dd"/></span></li>
<!--                                                       <li class="hit "><strong class="th">조회수</strong> -->
<%--                                                          <span class="td">${ oneNoticeVo.readcount }</span></li> --%>
                                                   </ul>
                                                </td>
                                             </tr>
                                             <tr>
                                                <th>첨부파일</th>
                                                <td>
                                                   <c:if test="${ not empty jattachList }">
                                                      <c:forEach var="jattach" items="${ jattachList }">
                                 
                                                         <c:choose>
                                                            <c:when test="${ jattach.image eq 'I' }">
                                                               <p>
                                                                  <a href="/upload/${ jattach.uploadpath }/${ jattach.uuid }_${ jattach.filename }">
                                                                     <img src="/upload/${ jattach.uploadpath }/s_${ jattach.uuid }_${ jattach.filename }">
                                                                  </a>
                                                               </p>
                                                            </c:when>
                                                            <c:otherwise>
                                                               <p>
                                                                  <a href="/fileNotice/download?num=${ jattach.num }">
                                                                     ${ jattach.filename } 
                                                                  </a>
                                                               </p>
                                                            </c:otherwise>
                                          ...
                                          <tbody>
                                             <tr>
                                                ...
                                                <td class="board_view_content"
                                                   ...
                                                   id="contents_820" valign="top">${ oneNoticeVo.content }</td>
                                             </tr>
                                          </tbody>
                                       </table>
                                    </td>
                                       ...
                                       <table width="100%">
                                          <tbody>
                                             <c:if test="${ not empty sessionScope.id }">
                                                <tr>
                                                   <td align="right"><input type="button"
                                                      value="1:1질문삭제" class="bhs_button yb"
                                                      style="float: none;" onclick="remove()"></td>
                                                </tr>
                                                <tr>
                                                   <td align="right"><input type="button"
                                                      value="1:1질문수정" class="bhs_button yb"
                                                      style="float: none;"
                                             ...
                                             <tr>
                                                <!-- 목록 -->
                                                <td align="right"><a
                                                   href="/userBoard/OneByOne?pageNum=${ pageNum }"><span
...
<%--                                     href="/userBoard/jnotice?num=${ num + 1 }&pageNum=${pageNum}">${ jnoticeVo.title }</a> --%>
<!--                                  </li> -->
                                 <br>
