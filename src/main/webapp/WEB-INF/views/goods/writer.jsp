            ...
            <table class="table">
               <tr>
                  <th scope="col" colspan="2"><input type="text" 
                     ...
                     placeholder="ex) 말린 감귤 / sub_goods"><br> <input v-model="price"
                     type="number" style="font-size: 34px;" name="salePrice" id="salePrice"
                     placeholder="ex) 1900 sale_price">
            ...
            <div class="panel panel-default" style="width: 500px;">
               ...
               <div id="collapse2" class="panel-collapse collapse" role="tabpanel">
                  <div class="panel-body">
                     ...
                     <span style="font-size: 20px;" name="discountRate" v-model="">{{ discountPrice }} % 할인율</span>
